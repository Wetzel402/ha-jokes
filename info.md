...
- 🏷️ **Rich Attributes**: Joke text, unique ID, source, category, and metadata stored as attributes
...
- **Attributes**: `joke`, `joke_id`, `source`, `category`, `last_updated`, `refresh_interval`
